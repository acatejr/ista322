# -*- coding: utf-8 -*-
"""ISTA_322_flatten_transform_json_Fall2022.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1So6qRIDApUB_Q0y6Jt74bCnaFxVeX4jt
...
plot = sns.scatterplot(data = top_track_info[top_track_info['artist_name'].isin(artist_info['artist_name'].sample(6))],
           x = 'danceability', 
           y = 'energy',
           hue = 'artist_name', 
           s = 200)
...
songs_agg = top_track_info.groupby(['artist_name'], as_index = False).agg({'danceability': ['mean'], 
                                                                        'energy': ['mean'], 
                                                                        'loudness': ['mean'],
                                                                        'speechiness': ['mean'],
                                                                        'acousticness': ['mean'], 
